...
<table width="782" border="1" bordercolor="#99CCFF" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
  ...
  <tr>
    <td width="782" height="75" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="42" height="27" align="center" background="images/logo/1.JPG" class="STYLE2"><a href="/ebuy/main" class="mainA">主页</a></td>
        <td width="63" align="center" background="images/logo/2.JPG" class="STYLE2"><a href="/ebuy/initReg" class="mainA">用户注册</a></td>
        <td width="63" align="center" background="images/logo/3.JPG" class="STYLE2"><a href="/ebuy/initMessage" class="mainA">意见反馈</a></td>
        <td width="74" align="center" background="images/logo/4.JPG" class="STYLE2"><a href="/ebuy/forgetPass" class="mainA">忘记密码</a></td>
      </tr>
