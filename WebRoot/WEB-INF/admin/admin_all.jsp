...
<table width="520" border="1" bordercolor="#99CCFF" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
  ...
  <tr>
    ...
    <td width="149" height="46" align="center"><span class="STYLE1">[ <a href="/ebuy/updateAdmin?id=${id }">查看/修改资料</a> ]</span></td>
    <td width="98" align="center"><span class="STYLE1">[ <a href="/ebuy/deleteAdmin?id=${id }">删除</a> ]</span></td>
  </tr>
  </s:iterator>
  <!-- 管理员集合迭代End -->
   <tr>
		<td height="30" colspan="5" align="center">
			<p align="center" class="STYLE1">
				...
				<s:if test="#request.currentPage>0">
					<span><a href="/ebuy/viewAdmin?currentPage=0"><u><b>首页</b></u></a></span>
					<span><a href="/ebuy/viewAdmin?currentPage=${currentPage-1 }"><u><b>上一页</b></u></a></span>&nbsp;&nbsp;&nbsp;
				</s:if>
				...
				<s:if test="#request.currentPage<#request.maxPage-1">
					<span><a href="/ebuy/viewAdmin?currentPage=${currentPage+1 }"><u><b>下一页</b></u></a></span>
					<span><a href="/ebuy/viewAdmin?currentPage=${maxPage-1 }"><u><b>尾页</b></u></a></span>
				</s:if>
