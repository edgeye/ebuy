...
<table width="520" border="1" bordercolor="#99CCFF" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
  ...
  <tr>
    <td height="35" align="center" class="STYLE1">${user }</td>
    <td height="32" align="center" class="STYLE1">${itemid }</td>
    <td height="32" align="center" class="STYLE1"><span class="STYLE1">${time}</span></td>
    <td align="center" class="STYLE1">${sum }</td>
		...
		<td height="30" colspan="6" align="center">
			<p align="center" class="STYLE1">
				...
				<s:if test="#request.currentPage>0">
					<span><a href="/ebuy/selectOrders?currentPage=0&name=${name}"><u><b>首页</b></u></a></span>
					<span><a href="/ebuy/selectOrders?currentPage=${currentPage-1 }&name=${name}"><u><b>上一页</b></u></a></span>&nbsp;&nbsp;&nbsp;
				</s:if>
				...
				<s:if test="#request.currentPage<#request.maxPage-1">
					<span><a href="/ebuy/selectOrders?currentPage=${currentPage+1 }&name=${name}"><u><b>下一页</b></u></a></span>
					<span><a href="/ebuy/selectOrders?currentPage=${maxPage-1 }&name=${name}"><u><b>尾页</b></u></a></span>
				</s:if>
