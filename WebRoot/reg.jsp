...
<center>
	...
	<table width="782" border="1" bordercolor="#99CCFF" style="border-collapse:collapse" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
    <td width="233" height="30" align="right" bgcolor="#99CCFF"><span class="STYLE1">用户名</span>：&nbsp;<span></span></td>
	...
	<tr>
        <td height="30" colspan="2" align="center"><span class="STYLE3">请检测用户名</span><span class="STYLE3">是否已经被使用</span></td>
	  </tr>
      <tr>
        <td height="30" colspan="2" align="center"><span class="STYLE3">用户名  已存在，请重新注册一个新的用户名。</span></td>
	  </tr>
	<tr>
        <td height="30" colspan="2" align="center"><span class="STYLE3">恭喜!  该用户名未成使用!请直接输入下表的内容！</span></td>
	  </tr>
    </table>
	</form>
</center>
